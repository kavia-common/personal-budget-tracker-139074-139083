...
export default function TransactionForm() {
  ...
  return (
    <form
      ...
      className="rounded-2xl border border-slate-700/60 bg-slate-900/70 p-4 ring-1 ring-emerald-500/20"
    >
      <h2 className="mb-3 text-lg font-extrabold tracking-wide text-emerald-300">
        Add Transaction
      </h2>
